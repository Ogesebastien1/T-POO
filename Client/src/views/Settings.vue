...
<template>
  ...
  >
    <div class="mx-auto grid w-full max-w-6xl gap-2">
      <h1 class="text-5xl font-semibold ml-6 mb-5">Settings</h1>
    </div>
    <div
      class="mx-auto grid w-full max-w-6xl items-start gap-6 md:grid-cols-[180px_1fr] lg:grid-cols-[0px_1fr]"
    >
